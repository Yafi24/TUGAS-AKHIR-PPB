...
public class cupang4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cupang4);
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInserted == true)
                    Toast.makeText(cupang4.this,"Data Saved",Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(cupang4.this,"Data Not Saved",Toast.LENGTH_SHORT).show();
            }
        });
    }
}}
