...
public class cupang1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cupang1);
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInserted == true)
                    Toast.makeText(cupang1.this,"Data Saved",Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(cupang1.this,"Data Not Saved",Toast.LENGTH_SHORT).show();
            }
        });
    }
}